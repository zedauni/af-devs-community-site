<template>
    <div class="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:px-0">
      <h2
        class="text-secondary text-3xl font-bold tracking-tighte"
      >
            ...
            <form @submit.prevent="addComment">
              <div>
                ...
                <textarea
                  ...
                  v-model="newComment"
                  rows="3"
                  class="focus:border focus:border-primary-200 p-2 focus:ring-primary-200 block w-full rounded-md border border-gray-200 shadow-sm sm:text-sm dark:border-gray-600"
                    ...
                    <form @submit.prevent="addReply(comment.id)">
                      <div>
                        ...
                        <textarea
                          ...
                          v-model="newReply"
                          rows="3"
                          class="p-2 focus:border-primary-500 focus:ring-primary-500 block w-full rounded-md border-gray-300 shadow-sm sm:text-sm dark:border-gray-600 "
